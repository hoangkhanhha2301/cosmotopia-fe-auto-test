    ...
    <footer className="bg-[#FAF8FF] py-8 w-full mx-auto">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="flex items-center text-[36px] mb-4">
              <img
                src={cosmeLogo}
                alt="cosme-logo"
            ...
            <div className="flex gap-4">
              ...
              <a href="http://linkedin.com/" className="text-gray-600 hover:text-gray-900">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-gray-600 hover:text-gray-900 font-montserrat">
                  Đặc trưng
                </a>
              </li>
              <li>
          ...
          <div className="space-y-4">
            <h3 className="font-semibold text-gray-900 font-montserrat">Công ty</h3>
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-gray-600 hover:text-gray-900 font-montserrat">
                  Thông tin
          ...
          <div className="space-y-4">
            <h3 className="font-semibold text-gray-900 font-montserrat">Hỗ trợ</h3>
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-gray-600 hover:text-gray-900 font-montserrat">
                  Trung tâm
          ...
          <div className="space-y-4">
            <h3 className="font-semibold text-gray-900 font-montserrat">Tải xuống</h3>
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-gray-600 hover:text-gray-900 font-montserrat">
                  iOS
