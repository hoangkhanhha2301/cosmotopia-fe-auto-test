...
export const brandItems: NavItem[] = [
  {
    title: 'MAC',
    subTitle: 'Thương hiệu mỹ phẩm nổi tiếng',
    href: '/assets/brand/mac.png',
    label: 'mac',
  },
  {
    title: 'Dior',
    subTitle: 'Thương hiệu thời trang cao cấp',
    href: '/assets/brand/mac.png',
    label: 'dior',
  },
  {
    title: "L'ORÉAL",
    subTitle: 'Sản phẩm chăm sóc sắc đẹp',
    href: '/assets/brand/mac.png',
    label: 'loreal',
  },
  {
    title: 'PRADA',
    subTitle: 'Thương hiệu thời trang xa xỉ',
    href: '/assets/brand/mac.png',
    label: 'prada',
  }
];
